...
int playGame(int n, int maxP, Player white, Player black, Goban goban) {
	...
	if (!result) {
		...
		showInvalid3x3(n, maxP, black, white, goban);
	}
...
void showInvalid3x3(int n, int maxP, Player p1, Player p2, Goban goban) {
	printf("\n\n\n\n---------- Isso formará uma estrutura 3x3. Por favor, jogue novamente. ----------\n\n\n\n");
	return playGame(n, maxP, p1, p2, goban);
}